<h2><a href="https://leetcode.com/problems/the-dining-philosophers/">1226. The Dining Philosophers</a></h2><h3>Medium</h3><hr><div><p>Five silent philosophers&nbsp;sit at a round table with bowls of spaghetti. Forks are placed between each pair of adjacent philosophers.</p>
...
<p style="text-align: center"><em>The problem statement and the image above are taken from <a href="https://en.wikipedia.org/wiki/Dining_philosophers_problem" target="_blank" previewlistener="true">wikipedia.org</a></em></p>
